...
<div class="stock-form-card">
    ...
    {{-- BRANCH LOCATION (PASTI LOCK DJUANDA) --}}
    <h4 class="form-section">Branch Location</h4>
    <div class="form-group">
        <label>Assigned Branch</label>
        <input type="text" value="Djuanda" readonly style="background-color: #f5f5f5; color: #666; font-weight: bold; border: 1px solid #eee;">
    </div>

    <div class="form-action" style="margin-top: 30px;">
        <a href="{{ route('djuanda.stock') }}" class="btn-cancel" style="background: #4A3525; color: #fff; text-align: center; line-height: normal; display: inline-flex; align-items: center; justify-content: center;">← Back to List</a>
        <a href="{{ route('djuanda.stock.edit', $stock->id) }}" class="btn-submit" style="background: #8C7A6B; color: #fff; text-decoration: none; text-align: center; display: inline-flex; align-items: center; justify-content: center;">Edit This Item</a>
    </div>
