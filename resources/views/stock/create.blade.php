...
<form action="{{ route('stock.store') }}" method="POST" enctype="multipart/form-data" class="stock-form">
@csrf
<div class="stock-form-card">
    ...
    <div class="form-group">
        <label>Choose Status <span>*</span></label>
        <select name="status" required>
            <option value="">Choose Status</option>
            <option value="IN STOCK" @selected(old('status') == 'IN STOCK')>IN STOCK</option>
            <option value="LOW STOCK" @selected(old('status') == 'LOW STOCK')>LOW STOCK</option>
            <option value="OUT OF STOCK" @selected(old('status') == 'OUT OF STOCK')>OUT OF STOCK</option>
        </select>
    </div>

    {{-- BRANCH --}}
    <h4 class="form-section">Assign Branch <span>*</span></h4>
    <div class="form-group">
    ...
    <div class="form-action">
        <a href="{{ route('stock.index') }}" class="btn-cancel">Cancel</a>
